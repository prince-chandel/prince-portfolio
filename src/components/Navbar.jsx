  ...
  return (
    <header className="sticky top-0 z-50 backdrop-blur bg-white/70 dark:bg-neutral-950/70 border-b border-neutral-200 dark:border-neutral-900 transition-colors duration-500">
      <div className="max-w-6xl mx-auto flex items-center justify-between py-3 px-4">
        ...
        {/* Dark mode toggle (always visible at far right) */}
        <button
          onClick={() => setDark(!dark)}
          className="ml-4 p-2 rounded-full border border-neutral-300 dark:border-neutral-700 hover:bg-neutral-100 dark:hover:bg-neutral-800 transition"
        >
          {dark ? <FaSun /> : <FaMoon />}
        </button>
      </div>
